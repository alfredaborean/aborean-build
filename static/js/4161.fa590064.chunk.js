...
`,w=d.default.ul.withConfig({displayName:"SelectOption__DropdownMenu",componentId:"sc-2a0a13f4-2"})`
  position: absolute;
  left: 0;
  width: 100%;
  background-color: ${({backgroundColor:e})=>e||"#ffffff"};
  ...
  transition: all 0.3s ease;
  z-index: 10;
`,C=d.default.li.withConfig({displayName:"SelectOption__DropdownItem",componentId:"sc-2a0a13f4-3"})`
  padding: 5px 16px;
  list-style: none;
  cursor: pointer;
  font-size: 16px;
...
`,$=d.default.span.withConfig({displayName:"SelectOption__Arrow",componentId:"sc-2a0a13f4-4"})`
...
`,k=({options:e,defaultOption:o,onSelect:r})=>{const[i,a]=(0,n.useState)(!1),[s,l]=(0,n.useState)(!1),[d,c]=(0,n.useState)(o||e[0]),u=(0,n.useRef)(null),f=(0,n.useRef)(null),b=(0,p.useSporeColors)();(0,n.useEffect)(()=>{const e=e=>{u.current&&!u.current.contains(e.target)&&a(!1)},o=()=>{if(u.current&&f.current){const e=u.current.getBoundingClientRect(),o=f.current.offsetHeight,r=window.innerHeight-e.bottom,t=e.top;l(r<o&&t>o)}};return i&&(o(),window.addEventListener("resize",o)),document.addEventListener("mousedown",e),()=>{document.removeEventListener("mousedown",e),window.removeEventListener("resize",o)}},[i]);const _={backgroundColor:b.surface1Hovered.val,hoverColor:b.accent3.val,borderColor:b.surface2Hovered.val,color:b.neutral1.val},h={borderColor:b.accent3.val},g={backgroundColor:b.surface1Hovered.val,borderColor:b.surface2Hovered.val},m={HoverBackgroundColor:b.surface2Hovered.val,color:b.neutral1.val,hoverColor:b.accent1.val};return(0,t.jsxs)(y,{ref:u,children:[(0,t.jsxs)(j,{onClick:()=>{a(!i)},..._,children:[(0,t.jsxs)(x.Text,{variant:"buttonLabel3",children:[" ",d]}),(0,t.jsx)($,{isOpen:i,...h})]}),(0,t.jsx)(w,{ref:f,isOpen:i,isAbove:s,...g,children:e.map(e=>(0,t.jsx)(C,{onClick:()=>(e=>{c(e),r(e),a(!1)})(e),...m,children:(0,t.jsx)(x.Text,{variant:"body3",children:e})},e))})]})};var S=r(43800),B=r(565);const L="  _display-flex _flexBasis-auto _boxSizing-border-box _position-relative _minHeight-0px _minWidth-0px _flexShrink-0 _flexDirection-row _alignItems-center _gap-t-space-gap52 ",R="  _display-flex _flexBasis-auto _boxSizing-border-box _position-relative _minHeight-0px _minWidth-0px _flexShrink-0 _flexDirection-row _gap-t-space-gap1573 _alignItems-center ",O="  _display-flex _flexBasis-auto _boxSizing-border-box _position-relative _minHeight-0px _minWidth-0px _flexShrink-0 _flexDirection-row _gap-t-space-gap1569 _alignItems-center ",z="  _display-flex _alignItems-stretch _flexBasis-auto _boxSizing-border-box _position-relative _minHeight-0px _minWidth-0px _flexShrink-0 _flexDirection-column _justifyContent-center _gap-t-space-gap56 ",T="  _display-flex _alignItems-stretch _flexBasis-auto _boxSizing-border-box _position-relative _minHeight-0px _minWidth-0px _flexShrink-0 _flexDirection-row _gap-t-space-gap1569 _mt-t-space-gap1569 ",W="  _display-flex _alignItems-stretch _flexBasis-auto _boxSizing-border-box _position-relative _minHeight-0px _minWidth-0px _flexShrink-0 _flexDirection-column ";function I(){const e=(0,p.useSporeColors)();return(0,t.jsxs)("div",{className:W,children:[(0,t.jsx)(x.Text,{variant:"buttonLabel3",color:"$neutral2",children:"Relay Strategy"}),(0,t.jsxs)("div",{className:T,children:[(0,t.jsx)(i.Flex,{p:"$padding12",borderRadius:"$rounded12",borderColor:"$accent3",style:{background:`linear-gradient(90deg, ${e.surface2.variable} 0%, ${e.slate.variable} 40%, ${e.surface2.variable} 60%, ${e.slate.variable} 100%)`},children:(0,t.jsx)(B.Z,{size:24,color:e.neutral1Hovered.val})}),(0,t.jsxs)("div",{className:z,children:[(0,t.jsxs)("div",{className:O,children:[(0,t.jsx)(x.Text,{variant:"buttonLabel3",children:"ABX Maxi"}),(0,t.jsx)(x.Text,{variant:"body4",color:"$neutral2",backgroundColor:"$surface3",py:"$padding4",px:"$padding8",borderRadius:"$rounded8",children:"ID 10298"})]}),(0,t.jsxs)("div",{className:R,children:[(0,t.jsx)(x.Text,{variant:"body4",color:"$neutral2",children:"Updated 5 hours ago"}),(0,t.jsx)("div",{className:L,children:(0,t.jsx)(S.Z,{address:"0x3470fe9a968013bb02b8496cd3c1d0a5743be76d"})})]})]})]})]})}r(1870);var H=r(86683),D=r(1994);const N="  _display-flex _flexBasis-auto _boxSizing-border-box _position-relative _minHeight-0px _minWidth-0px _flexShrink-0 _flexDirection-row _justifyContent-space-betwe3241 _gap-t-space-spa1360334076 _alignItems-center  _flexDirection-_lg_column _alignItems-_lg_flex-start";function A(){return(0,t.jsxs)("div",{className:N,children:[(0,t.jsx)(x.Text,{variant:"body3",color:"$neutral2",children:"Select the Lock you want to deposit"}),(0,t.jsx)(H.Link,{className:"text-decoration-none inline-flex",to:"/lock",children:(0,t.jsx)(D.R,{as:"button",className:"button-clear",color:"white",speed:"3s",py:10,children:(0,t.jsx)(x.Text,{variant:"buttonLabel3",color:"$neutral1",children:"Create new lock"})})})]})}function Z(){const e=(0,p.useSporeColors)(),o=["your locks...","Lock #83066 with  0.001 ABX","Lock #83067 with  0.157 ABX","Lock #83068 with  541 ABX"];return(0,t.jsxs)(i.Flex,{flexDirection:"column",backgroundColor:"$surface2",p:"$spacing16",borderRadius:"$rounded12",gap:"$gap36",borderWidth:1,borderColor:"$surface3",$lg:{gap:"$spacing24"},style:{background:`linear-gradient(180deg, ${e.surface2.variable} 0%, transparent 100%)`},children:[(0,t.jsx)(A,{}),(0,t.jsx)(k,{options:o,defaultOption:o[0],onSelect:()=>{}}),(0,t.jsx)(I,{}),(0,t.jsx)(v.Z,{children:(0,t.jsx)(x.Text,{variant:"body3",children:"I understand that by depositing my Lock into a Relay strategy, the Lock unlock date will be extended to 4 years."})})]})}function E(){return(0,t.jsxs)(i.Flex,{gap:"$gap24",mt:"$spacing24",width:"100%",px:"$spacing40",maxWidth:1024,pb:"$spacing40","$platform-web":{display:"grid",gridTemplateColumns:"4fr 3fr"},$md:{gridTemplateColumns:"1fr"},$xl:{px:"$spacing12",mx:"auto"},children:[(0,t.jsx)(Z,{}),(0,t.jsx)(m,{})]})}r(2030)},565:(e,o,r)=>{r.d(o,{Z:()=>d});var t=r(20128),i=r(88378),n=r.n(i);function a(){return a=Object.assign||function(e){for(var o=1;o<arguments.length;o++){var r=arguments[o];for(var t in r)Object.prototype.hasOwnProperty.call(r,t)&&(e[t]=r[t])}return e},a.apply(this,arguments)}function s(e,o){if(null==e)return{};var r,t,i=function(e,o){if(null==e)return{};var r,t,i={},n=Object.keys(e);for(t=0;t<n.length;t++)r=n[t],o.indexOf(r)>=0||(i[r]=e[r]);return i}(e,o);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);for(t=0;t<n.length;t++)r=n[t],o.indexOf(r)>=0||Object.prototype.propertyIsEnumerable.call(e,r)&&(i[r]=e[r])}return i}var l=(0,t.forwardRef)(function(e,o){var r=e.color,i=void 0===r?"currentColor":r,n=e.size,l=void 0===n?24:n,d=s(e,["color","size"]);return t.createElement("svg",a({ref:o,xmlns:"http://www.w3.org/2000/svg",width:l,height:l,viewBox:"0 0 24 24",fill:"none",stroke:i,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},d),t.createElement("path",{d:"M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"}),t.createElement("polyline",{points:"3.27 6.96 12 12.01 20.73 6.96"}),t.createElement("line",{x1:"12",y1:"22.08",x2:"12",y2:"12"}))});l.propTypes={color:n().string,size:n().oneOfType([n().string,n().number])},l.displayName="Box";const d=l}}]);
//# sourceMappingURL=4161.fa590064.chunk.js.map