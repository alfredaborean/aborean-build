...
`;function A(){const{activeOption:e,selectedLockId:r,formData:n}=l(),{address:i}=(0,h.m)(),[s,c]=((0,x.useSporeColors)(),(0,a.useState)(!1)),{data:u}=(0,d.G_)(r||void 0),{data:g}=L(n.selectedMergeLockId),{data:k}=I(n.selectedMergeLockId),{data:y}=F(n.selectedMergeLockId),{data:C}=I(r||void 0),{data:T}=F(r||void 0),{approveABX:M,increaseLockAmount:A,extendLockTime:E,lockPermanent:S,mergeLocks:_,transferLock:N,needsApproval:z,getFormattedABXBalance:B,isWritePending:R,isConfirming:W,isSuccess:q,writeError:H,transactionHash:Z,refetchAllowance:O}=(0,b.Y)(),{refetch:V}=(0,d.Zz)(i),[X,Y]=(0,a.useState)(null),[U,G]=(0,a.useState)(null);(0,a.useEffect)(()=>{if(q&&U){if("approve"===U)console.log("Approval confirmed, proceeding with main action..."),G(null),setTimeout(()=>{O().then(()=>{J()})},1e3);else if("execute"===U){G(null);const e={increase:"Amount Increased",extend:"Lock Extended",permanent:"Lock Made Permanent",merge:"Locks Merged",transfer:"Lock Transferred"};m.Z.addPopup({type:f.k.LockSuccess,content:{type:"success",title:e[X]||"Lock Updated",description:`Successfully ${X} lock ${r}`,hash:Z,action:X}},`lock-${X}-${Z}`,8e3),V(),Y(null),c(!1)}}else if(H&&(X||U)){const e=H.message;if(e.toLowerCase().includes("user rejected")||e.toLowerCase().includes("user denied")||e.toLowerCase().includes("rejected by user"))m.Z.addPopup({type:f.k.LockError,content:{type:"error",title:"Transaction Cancelled",description:`${X} operation was cancelled by user`,action:X}},`lock-${X}-cancelled-${Date.now()}`,5e3);else{const r={increase:"Increase Amount",extend:"Extend Lock",permanent:"Make Permanent",merge:"Merge Locks",transfer:"Transfer Lock"};m.Z.addPopup({type:f.k.LockError,content:{type:"error",title:`${r[X]||"Lock Update"} Failed`,description:`Failed to ${X} lock: ${e}`,action:X}},`lock-${X}-error-${Date.now()}`,1e4)}Y(null),G(null),c(!1)}},[q,H,X,U,Z,r,V,O]);const Q=()=>{if(!i||!r)return!1;switch(e){case"Increase":{if(!(0,p.Rm)(n.increaseAmount).isValid)return!1;const e=parseFloat(B()),r=parseFloat(n.increaseAmount);return r>0&&r<=e}case"Extend":return(n.extendDays>0||n.extendToMaxLock)&&!!u&&!u.permanent;case"Merge":var o;if(!n.selectedMergeLockId||!u||u.managed)return!1;if(!0===g)return!1;if(!0===(null===(o=y)||void 0===o?void 0:o.isPermanent))return!1;if(T&&!T.isPermanent){const e=Math.floor(Date.now()/1e3);if(Number(T.end)<=e)return!1}return!0;case"Transfer":return!(!n.transferToAddress||!u)&&(!!(0,w.U)(n.transferToAddress)&&("0x0000000000000000000000000000000000000000"!==n.transferToAddress&&(!i||n.transferToAddress.toLowerCase()!==i.toLowerCase())));default:return!1}},J=function(){var o=D(function*(){if(Q()&&!s){G("execute");try{switch(e){case"Increase":yield A({tokenId:r,amount:n.increaseAmount});break;case"Extend":if(!u)return;if(n.extendToMaxLock)yield S(r);else{const e=n.extendDays,o=Math.floor(Date.now()/1e3),t=parseInt(u.lockEnd),a=Math.max(0,(0,p.i8)(t-o))+e;yield E({tokenId:r,lockDurationInDays:a})}break;case"Merge":if(!n.selectedMergeLockId||!u)return;yield _({fromTokenId:n.selectedMergeLockId,toTokenId:r});break;case"Transfer":if(!n.transferToAddress||!u)return;yield N({tokenId:r,toAddress:n.transferToAddress})}}catch(o){throw console.error("Main transaction failed:",o),G(null),o}}});return function(){return o.apply(this,arguments)}}(),K=function(){var r=D(function*(){if(Q()&&!s){c(!0);try{switch(e){case"Increase":Y("increase");break;case"Extend":Y(n.extendToMaxLock?"permanent":"extend");break;case"Merge":Y("merge");break;case"Transfer":Y("transfer")}"Increase"===e&&z(n.increaseAmount)?(console.log("Approval needed, starting approval transaction..."),G("approve"),yield M(n.increaseAmount)):yield J()}catch(r){if(console.error("Transaction failed:",r),X){const e=r instanceof Error?r.message:"Unknown error";if(e.toLowerCase().includes("user rejected")||e.toLowerCase().includes("user denied")||e.toLowerCase().includes("rejected by user"))m.Z.addPopup({type:f.k.LockError,content:{type:"error",title:"Transaction Cancelled",description:`${X} operation was cancelled by user`,action:X}},`lock-${X}-cancelled-${Date.now()}`,5e3);else{const r={increase:"Increase Amount",extend:"Extend Lock",permanent:"Make Permanent",merge:"Merge Locks",transfer:"Transfer Lock"};m.Z.addPopup({type:f.k.LockError,content:{type:"error",title:`${r[X]||"Lock Update"} Failed`,description:`Failed to ${X} lock: ${e}`,action:X}},`lock-${X}-error-${Date.now()}`,1e4)}}Y(null),G(null)}finally{c(!1)}}});return function(){return r.apply(this,arguments)}}(),ee=!Q()||s||R||W,re=s||R||W,ne=(0,v.s0)();return(0,o.jsxs)(t.Flex,{mt:"$spacing36",row:!0,gap:"$gap12",alignItems:"center",children:[(0,o.jsx)(P,{$lock:!0,$isDisabled:!1,onClick:()=>ne("/locks"),children:(0,o.jsx)($.Text,{variant:"buttonLabel3",color:"inherit",children:"Change Lock"})}),(0,o.jsx)(P,{onClick:K,$isDisabled:ee,children:(0,o.jsxs)(t.Flex,{row:!0,gap:"$gap8",alignItems:"center",children:[s&&(0,o.jsx)(j.n,{size:20}),(0,o.jsx)($.Text,{variant:"buttonLabel3",color:"inherit",children:re?"Processing...":"Increase"===e&&z(n.increaseAmount)?"Approve & Increase":(()=>{switch(e){case"Increase":return"Increase";case"Extend":return n.extendToMaxLock?"Convert to Permanent":"Extend Lock Time";case"Merge":return"Merge";case"Transfer":return"Transfer";default:return"Update"}})()})]})})]})}var E=n(52964),S=n(20868);const[_,N]=(0,S.I)({name:"NoNfts",getIcon:e=>(0,o.jsx)(E.ny,{viewBox:"0 0 24 24",fill:"none",...e,children:(0,o.jsx)("path",{fill:"currentColor",d:"M6.327 20.539q-1.2 0-2.033-.833t-.832-2.033t.832-2.033t2.033-.832t2.033.832t.832 2.033q0 .503-.172.972t-.497.841v-.29q.808.402 1.685.603T12 20q3.35 0 5.675-2.325T20 12h1q0 1.864-.709 3.507q-.708 1.643-1.923 2.859t-2.858 1.925T12 21q-1.065 0-2.084-.238t-1.98-.731q-.361.263-.773.385t-.836.122m.001-1q.778 0 1.321-.544t.543-1.322t-.544-1.321t-1.322-.543t-1.321.544q-.544.545-.544 1.322t.545 1.321t1.322.544M12 14.865q-1.2 0-2.033-.832T9.135 12t.832-2.033T12 9.135t2.033.832t.833 2.033t-.833 2.033t-2.033.833M3 12q0-1.864.709-3.507t1.924-2.859T8.49 3.709T12 3q1.066 0 2.084.238t1.98.731q.37-.244.774-.366t.835-.122q1.2 0 2.023.823t.823 2.023t-.823 2.033t-2.023.832t-2.033-.832t-.832-2.033q0-.503.172-.972t.497-.842v.29q-.808-.401-1.685-.602Q12.916 4 12 4Q8.65 4 6.325 6.325T4 12zm14.673-3.808q.77 0 1.308-.553t.538-1.312t-.538-1.303t-1.308-.543q-.76 0-1.312.54q-.553.54-.553 1.313t.544 1.315t1.321.543m0-1.865"})})});var z=n(74456),B=n(4925),R=n(88861);const W=(0,z.z)(B.Kq,{width:40,height:20,borderRadius:20,borderWidth:0,cursor:"pointer",padding:"10px 0",variants:{checked:{true:{backgroundColor:"$absGreen"},false:{backgroundColor:"$accent2"}}},defaultVariants:{checked:!1}}),q=(0,z.z)(B.Kq,{width:18,height:18,backgroundColor:"$neutral1",borderRadius:18}),H=(0,R.r)({Frame:W,Thumb:q});function Z({checked:e,onCheckedChange:r,disabled:n}){return(0,o.jsx)(H,{checked:e,onCheckedChange:n?void 0:r,disabled:n,children:(0,o.jsx)(H.Thumb,{animation:"quicker"})})}const O=k.default.input.withConfig({displayName:"Range__StyledRange",componentId:"sc-1a0ac455-0"})`
...
`,V=k.default.div.withConfig({displayName:"Range__DatalistPoints",componentId:"sc-1a0ac455-1"})`
  position: absolute;
  bottom: -12px;
  left: 0;
  right: 0;
  height: 4px;
  pointer-events: none;
`,X=k.default.div.withConfig({displayName:"Range__DatalistPoint",componentId:"sc-1a0ac455-2"})`
  position: absolute;
  width: 4px;
  height: 4px;
...
`,Y=({value:e=0,onChange:r,min:n=0,max:a=100,label:i})=>{const s=a-n,c=s>0?[25,50,75]:[],l=(0,x.useSporeColors)(),d=s>0?(e-n)/s*100:0;return(0,o.jsxs)(t.Flex,{flexDirection:"column",width:"100%",my:"$gap24",gap:"$gap12",children:[i&&(0,o.jsx)($.Text,{variant:"body3",color:"$neutral1",textAlign:"center",children:i}),(0,o.jsxs)(t.Flex,{row:!0,gap:"$gap12",alignItems:"center",width:"100%",children:[(0,o.jsx)($.Text,{variant:"body4",color:"$neutral3",children:n}),(0,o.jsxs)(t.Flex,{position:"relative",grow:!0,children:[(0,o.jsx)(O,{type:"range",min:n,max:a,value:e,onChange:e=>{var n;const o=Number(e.target.value);null===(n=r)||void 0===n||n(o)},list:"range-datalist",style:{background:`linear-gradient(\n              to right,\n              ${l.accent1Hovered.val} 0%,\n              ${l.accent1Hovered.val} ${d}%,\n              ${l.accent2.val} ${d}%,\n               ${l.accent2.val} 100%\n            )`}}),(0,o.jsx)(V,{children:c.map((e,r)=>(0,o.jsx)(X,{position:e,className:e<=d?"active":""},r))}),(0,o.jsx)("datalist",{id:"range-datalist",children:c.map((e,r)=>(0,o.jsx)("option",{value:n+s*e/100},r))})]}),(0,o.jsx)($.Text,{variant:"body4",color:"$neutral3",children:a})]})]})};function U(){const{selectedLockId:e,formData:r,updateFormData:n}=l(),{data:i}=(0,d.G_)(e||void 0),{remainingDays:s,maxExtensionDays:c,maxLockDays:u,isAlreadyPermanent:x}=(0,a.useMemo)(()=>{var e;const r=Math.floor(Date.now()/1e3),n=i?parseInt(i.lockEnd):r,o=Math.max(0,(0,p.i8)(n-r)),t=(0,p.i8)(p.Q_);return{remainingDays:o,maxLockDays:t,maxExtensionDays:t-o,isAlreadyPermanent:(null===(e=i)||void 0===e?void 0:e.permanent)||!1}},[i]),g=(0,a.useCallback)(e=>{n({extendToMaxLock:e,extendDays:0})},[n]);return(0,o.jsxs)(t.Flex,{mt:"$gap36",children:[(0,o.jsxs)(t.Flex,{borderWidth:1,borderColor:"$surface3",borderRadius:"$rounded12",p:"$padding12",children:[(0,o.jsxs)(t.Flex,{row:!0,gap:"$gap12",alignItems:"center",children:[(0,o.jsx)(Z,{checked:x||r.extendToMaxLock,onCheckedChange:g,disabled:x}),(0,o.jsx)($.Text,{variant:"buttonLabel3",children:"Permanent Lock Mode"}),(0,o.jsx)(_,{size:20,color:"$neutral3"})]}),(0,o.jsx)($.Text,{variant:"body4",mt:"$gap12",children:x?"This lock is already permanent and has maximum 1-to-1 voting power.":"When activated, converts this lock to a permanent lock with maximum 1-to-1 voting power. Permanent locks never expire and don't need to be extended."}),x&&(0,o.jsx)($.Text,{variant:"body4",mt:"$gap12",color:"$accent1",children:"\u2713 Lock is already permanent"})]}),!x&&!r.extendToMaxLock&&c>0&&(0,o.jsx)(Y,{value:r.extendDays,onChange:e=>n({extendDays:e}),min:0,max:c,label:`Extend by ${r.extendDays} days`}),!x&&r.extendToMaxLock&&(0,o.jsx)(t.Flex,{mt:"$gap24",p:"$padding12",borderWidth:1,borderColor:"$accent1",borderRadius:"$rounded12",children:(0,o.jsx)($.Text,{variant:"body3",color:"$accent1",children:"Will convert to permanent lock with maximum voting power (1:1 ratio)"})}),!x&&c<=0&&!r.extendToMaxLock&&(0,o.jsx)(t.Flex,{mt:"$gap24",p:"$padding12",borderWidth:1,borderColor:"$neutral3",borderRadius:"$rounded12",children:(0,o.jsx)($.Text,{variant:"body3",color:"$neutral2",children:"This lock is already at maximum duration. You can convert it to a permanent lock for maximum voting power."})})]})}var G=n(71960),Q=n(84308);function J(){const{address:e}=(0,h.m)(),{getFormattedABXBalance:r,needsApproval:n,isWritePending:a}=(0,b.Y)(),{formData:i,updateFormData:s}=l(),c=i.increaseAmount,d=r(),u=(0,p.Rm)(c),x=!u.isValid;let g=u.error;if(u.isValid&&c){const e=parseFloat(d);parseFloat(c)>e&&(g="Insufficient ABX balance")}return(0,o.jsxs)(t.Flex,{mt:"$gap36",children:[(0,o.jsx)(Q.Z,{title:"Add to lock",onPercentageSelect:e=>{const r=parseFloat(d);if(r>0){const n=(r*e/100).toString();s({increaseAmount:n})}}}),(0,o.jsx)(t.Flex,{mt:"$gap12",children:(0,o.jsx)(G.Z,{value:c,onValueChange:e=>{s({increaseAmount:e})},error:g,userBalance:d})}),e&&c&&!x&&(0,o.jsx)(t.Flex,{mt:"$gap12",p:"$spacing12",backgroundColor:"$surface3",borderRadius:"$rounded8",children:(0,o.jsx)($.Text,{variant:"body4",color:"$neutral2",children:n(c)?`Approval required for ${c} ABX`:`Ready to increase lock by ${c} ABX`})})]})}var K=n(126),ee=n(38046);const re=k.default.div.withConfig({displayName:"SelectLock__DropdownWrapper",componentId:"sc-d9aeb57-0"})`
  position: relative;
  width: 100%;
...
`;function Te({}){const{activeOption:e,setActiveOption:r}=l(),n=(0,x.useSporeColors)(),a=["Increase","Extend","Merge","Transfer"];return(0,o.jsxs)(t.Flex,{flexDirection:"column",children:[(0,o.jsx)(t.Flex,{row:!0,gap:"$gap12",px:"$spacing8",justifyContent:"space-between",$md:{display:"none"},children:a.map(t=>(0,o.jsx)(Ce,{role:"button",$colors:n,className:""+(e===t?"active":""),onClick:()=>r(t),children:(0,o.jsx)($.Text,{variant:"buttonLabel3",color:"inherit",children:t})},t))}),(0,o.jsx)(ye,{options:a}),(0,o.jsx)(be.Z,{width:"100%",mt:"-1px",height:1})]})}var Le=n(91128);const[Ie,Fe]=(0,S.I)({name:"Wallet",getIcon:e=>(0,o.jsxs)(E.ny,{viewBox:"0 0 24 24",fill:"none",...e,children:[(0,o.jsx)(E.y$,{d:"M4 3.99902C2.34315 3.99902 1 5.34217 1 6.99902V17.999C1 19.6559 2.34315 20.999 4 20.999H20C21.6569 20.999 23 19.6559 23 17.999V6.99902C23 5.34217 21.6569 3.99902 20 3.99902H4ZM3 17.999V10.999C3 10.4475 3.44812 9.99902 4.00115 9.99902H19.9989C20.5519 9.99902 21 10.4475 21 10.999V17.999C21 18.5513 20.5523 18.999 20 18.999H4C3.44772 18.999 3 18.5513 3 17.999ZM19.9989 7.99902C20.3498 7.99902 20.6868 8.05931 21 8.17011V6.99902C21 6.44674 20.5523 5.99902 20 5.99902H4C3.44772 5.99902 3 6.44674 3 6.99902V8.17011C3.31318 8.05931 3.65018 7.99902 4.00115 7.99902H19.9989Z",fill:"currentColor",fillRule:"evenodd",clipRule:"evenodd"}),(0,o.jsx)(E.y$,{d:"M3 11.999V13.999H7.35465C7.9611 15.5239 9.50565 16.8562 12 16.8562C13.271 16.8562 14.3391 16.5093 15.1735 15.8493C15.9093 15.2674 16.3172 14.5566 16.5574 13.999H21V11.999H16C15.4477 11.999 14.9935 12.5275 14.7645 13.1018C14.4438 13.9062 13.789 14.8562 12 14.8562C10.29 14.8562 9.48213 13.9883 9.1936 13.2092C8.96575 12.594 8.49905 11.999 7.91447 11.999H3Z",fill:"currentColor"})]})});function Me(e,r,n,o,t,a,i){try{var s=e[a](i),c=s.value}catch(l){return void n(l)}s.done?r(c):Promise.resolve(c).then(o,t)}function De(e){return function(){var r=this,n=arguments;return new Promise(function(o,t){var a=e.apply(r,n);function i(e){Me(a,o,t,i,s,"next",e)}function s(e){Me(a,o,t,i,s,"throw",e)}i(void 0)})}}const Pe=(0,k.default)(t.Flex).withConfig({displayName:"Transfer__ErrorContainer",componentId:"sc-31107061-0"})`
  background-color: ${({$colors:e})=>e.surface2.val};
  border: 1px solid ${({$colors:e})=>e.statusCritical.val};
  border-radius: 12px;
  padding: 12px;
  margin-top: 12px;
`,Ae=(0,k.default)(t.Flex).withConfig({displayName:"Transfer__InputContainer",componentId:"sc-31107061-1"})`
...
`,Ee=k.default.button.withConfig({displayName:"Transfer__Button",componentId:"sc-31107061-2"})`
  all: unset;
  padding: 10px 12px;
  border: 1px solid ${({theme:e})=>e.surface3};
