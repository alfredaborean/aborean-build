...
`,C=l.default.div.withConfig({displayName:"Range__DatalistPoints",componentId:"sc-a033b85c-1"})`
  position: absolute;
  bottom: -12px;
  left: 0;
  right: 0;
  height: 4px;
  pointer-events: none;
`,S=l.default.div.withConfig({displayName:"Range__DatalistPoint",componentId:"sc-a033b85c-2"})`
  position: absolute;
  width: 4px;
  height: 4px;
...
//# sourceMappingURL=3839.fb8efecb.chunk.js.map