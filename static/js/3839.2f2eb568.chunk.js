...
`,C=l.default.div.withConfig({displayName:"Range__DatalistPoints",componentId:"sc-212c276b-1"})`
  position: absolute;
  bottom: -12px;
  left: 0;
  right: 0;
  height: 4px;
  pointer-events: none;
`,S=l.default.div.withConfig({displayName:"Range__DatalistPoint",componentId:"sc-212c276b-2"})`
  position: absolute;
  width: 4px;
  height: 4px;
...
//# sourceMappingURL=3839.2f2eb568.chunk.js.map