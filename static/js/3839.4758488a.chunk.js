...
`,C=l.default.div.withConfig({displayName:"Range__DatalistPoints",componentId:"sc-84f1e365-1"})`
  position: absolute;
  bottom: -12px;
  left: 0;
  right: 0;
  height: 4px;
  pointer-events: none;
`,S=l.default.div.withConfig({displayName:"Range__DatalistPoint",componentId:"sc-84f1e365-2"})`
  position: absolute;
  width: 4px;
  height: 4px;
...
//# sourceMappingURL=3839.4758488a.chunk.js.map