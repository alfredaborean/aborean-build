...
`,C=l.default.div.withConfig({displayName:"Range__DatalistPoints",componentId:"sc-ff376e7b-1"})`
  position: absolute;
  bottom: -12px;
  left: 0;
  right: 0;
  height: 4px;
  pointer-events: none;
`,S=l.default.div.withConfig({displayName:"Range__DatalistPoint",componentId:"sc-ff376e7b-2"})`
  position: absolute;
  width: 4px;
  height: 4px;
...
//# sourceMappingURL=3839.88132605.chunk.js.map