...
`,C=l.default.div.withConfig({displayName:"Range__DatalistPoints",componentId:"sc-a95e1d59-1"})`
  position: absolute;
  bottom: -12px;
  left: 0;
  right: 0;
  height: 4px;
  pointer-events: none;
`,S=l.default.div.withConfig({displayName:"Range__DatalistPoint",componentId:"sc-a95e1d59-2"})`
  position: absolute;
  width: 4px;
  height: 4px;
...
`,Z=l.default.ul.withConfig({displayName:"SelectLock__DropdownMenu",componentId:"sc-50cfa101-2"})`
  position: absolute;
  left: 0;
  width: 100%;
  background-color: ${({backgroundColor:e})=>e||"#ffffff"};
  ...
  transition: all 0.3s ease;
  z-index: 10;
`,O=l.default.li.withConfig({displayName:"SelectLock__DropdownItem",componentId:"sc-50cfa101-3"})`
  padding: 5px 16px;
  list-style: none;
  cursor: pointer;
  font-size: 16px;
...
`,V=({options:e,defaultOption:t,onSelect:o})=>{const[i,s]=(0,a.useState)(!1),[l,c]=(0,a.useState)(!1),[p,x]=(0,a.useState)(t||e[0]),_=(0,a.useRef)(null),u=(0,a.useRef)(null),b=(0,n.useSporeColors)();(0,a.useEffect)((()=>{const e=e=>{_.current&&!_.current.contains(e.target)&&s(!1)},t=()=>{if(_.current&&u.current){const e=_.current.getBoundingClientRect(),t=u.current.offsetHeight,o=window.innerHeight-e.bottom,r=e.top;c(o<t&&r>t)}};return i&&(t(),window.addEventListener("resize",t)),document.addEventListener("mousedown",e),()=>{document.removeEventListener("mousedown",e),window.removeEventListener("resize",t)}}),[i]);const h={backgroundColor:b.surface1Hovered.val,hoverColor:b.accent3.val,borderColor:b.surface2Hovered.val,color:b.neutral1.val},f={borderColor:b.accent3.val},g={backgroundColor:b.surface1Hovered.val,borderColor:b.surface2Hovered.val},m={HoverBackgroundColor:b.surface2Hovered.val,color:b.neutral1.val,hoverColor:b.accent1.val};return(0,r.jsxs)(A,{ref:_,children:[(0,r.jsxs)(M,{onClick:()=>{s(!i)},...h,children:[(0,r.jsxs)(d.Text,{variant:"buttonLabel3",children:[" ",p]}),(0,r.jsx)(E,{isOpen:i,...f})]}),(0,r.jsx)(Z,{ref:u,isOpen:i,isAbove:l,...g,children:e.map((e=>(0,r.jsx)(O,{onClick:()=>(e=>{x(e),o(e),s(!1)})(e),...m,children:(0,r.jsx)(d.Text,{variant:"body3",children:e})},e)))})]})},F="  _display-flex _flexBasis-auto _boxSizing-border-box _position-relative _minHeight-0px _minWidth-0px _flexShrink-0 _flexDirection-row _alignItems-center _gap-t-space-gap56 _mt-t-space-spa1360334080 ",G="  _display-flex _flexBasis-auto _boxSizing-border-box _position-relative _minHeight-0px _minWidth-0px _flexShrink-0 _flexDirection-row _justifyContent-space-betwe3241 _alignItems-center _gap-t-space-gap1569 _mb-t-space-gap1569 ",X="  _display-flex _alignItems-stretch _flexBasis-auto _boxSizing-border-box _position-relative _minHeight-0px _minWidth-0px _flexShrink-0 _flexDirection-column _mt-t-space-gap1635 ";function P(){const e=["Lock #83066 with  0.001 ABX","Lock #83067 with  0.157 ABX","Lock #83068 with  541 ABX"];return(0,r.jsxs)("div",{className:X,children:[(0,r.jsxs)("div",{className:G,children:[(0,r.jsx)(d.Text,{variant:"buttonLabel3",color:"$neutral2",children:"Select a Lock to merge with #83065"}),(0,r.jsx)(q.Link,{to:"/locks",className:"text-decoration-none",children:(0,r.jsx)(d.Text,{variant:"buttonLabel3",transition:"color 0.2s ease",hoverStyle:{color:"$accent1Hovered"},children:"Create new lock"})})]}),(0,r.jsx)(V,{options:e,defaultOption:e[0],onSelect:()=>{}}),(0,r.jsxs)("div",{className:F,children:[(0,r.jsx)(d.Text,{variant:"body3",color:"$neutral3",children:"Merging an Auto Max-Lock"})," ",(0,r.jsx)(j,{size:18,color:"$neutral3"}),(0,r.jsx)(d.Text,{variant:"body3",color:"$neutral3",children:"is not allowed."})]})]})}o(51909);const Q="  is_Separator _display-flex _alignItems-stretch _flexDirection-column _flexBasis-auto _boxSizing-border-box _position-relative _minHeight-0px _minWidth-0px _borderTopColor-surface3 _borderRightColor-surface3 _borderBottomColor-surface3 _borderLeftColor-surface3 _flexShrink-1 _borderTopWidth-0px _borderRightWidth-0px _borderBottomWidth-1px _borderLeftWidth-0px _flexGrow-1 _maxHeight-0px _width-10037 _mt--1px _height-1px _borderBottomStyle-solid _borderTopStyle-solid _borderLeftStyle-solid _borderRightStyle-solid ",Y="  _display-flex _alignItems-stretch _flexBasis-auto _boxSizing-border-box _position-relative _minHeight-0px _minWidth-0px _flexShrink-0 _flexDirection-row _gap-t-space-gap1569 _justifyContent-space-betwe3241 ",K="  _display-flex _alignItems-stretch _flexBasis-auto _boxSizing-border-box _position-relative _minHeight-0px _minWidth-0px _flexShrink-0 _flexDirection-column ";function J({activeOption:e,setActiveOption:t}){const o=(0,n.useSporeColors)(),i=l.default.button.withConfig({displayName:"ToggleOptions__Button",componentId:"sc-93ff3ddc-0"})`
    all: unset;
    padding: 16px 34px;
...
//# sourceMappingURL=3839.cfc24ae1.chunk.js.map